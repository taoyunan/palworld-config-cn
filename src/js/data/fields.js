...
DeathPenalty|pvp|select|All|死亡惩罚|死亡后掉落规则。|None,Item,ItemAndEquipment,All
...
PalEggDefaultHatchingTime|balance|float|72.000000|巨大蛋孵化小时|巨大蛋孵化所需时间；其他蛋也会按规则需要孵化时间。|
...
bIsStartLocationSelectByMap|features|boolean|True|允许地图选择出生点|是否允许玩家选择起始地点。|
...
BanListURL|server|string|https://api.palworldgame.com/api/banlist.txt|封禁列表 URL|封禁列表地址。|
SupplyDropSpan|balance|integer|180|陨石或空投间隔分钟|陨石或补给空投出现间隔，单位分钟。|
ChatPostLimitPerMinute|server|integer|10|每分钟聊天上限|每分钟允许发送的聊天消息数量。|
